...
<div id="header-bg">
	...
	<div id="header">
		<a href="index.html"><img src="images/we-care.png" alt="Package" width="205" height="62" border="0" class="logo" title="Package" /></a>
...
<div id="navigation-bg">
	...
	<div id="navigation">
		<ul class="mainMenu">
			...
			<li><a href="./UserEstimation" title="Estimation">Estimation</a></li>
...
<style>
#eeid{
margin: 0px 20px 23px 33px;
padding: 86px 106px 92px 83px;
}
</style>
...
<body >
  ...
  <div id="eeid">
	<table border="4" bgcolor="pink" id="eid">
	<h2><center><font color="Red"> We Only Accept Up to 200 Kg's</font></center></h2>
	
	
	
	
		<th>Lower Limit(Kg)</th>

		<th>Higher Limit(Kg)</th>
		<th>Cost</th>

		<% List<EstimationCost> u=(List)request.getAttribute("userlist");
   Iterator<EstimationCost> itr=u.iterator();
   while(itr.hasNext()){
  EstimationCost cost=itr.next();
     
       %>
		<tr>
			<td><%=cost.getLowerLimit()%></td>
			<td><%=cost.getHigherLimit()%></td>
			<td><%=cost.getCost()%></td>
		</tr>
		<%
}

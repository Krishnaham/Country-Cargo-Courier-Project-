...
<div id="navigation-bg">
	...
	<div id="navigation">
		<ul class="mainMenu">
			...
			<li><a href="ContactUs.jsp" title="About">ContactUs</a></li>
			

			
			<li><a href="SearchCourier.jsp " title="Admin">Track Courier</a></li>
...
<style type="text/css">
#tab{
   padding: 27px 42px 52px 10px;
    padding-top: 10px;
    padding-right: 22px;
    padding-bottom: 25px;
    padding-left: 10px;
margin: 0px 49px 12px -211px;
}
</style>

<div id="tab">
<table border="5" bgcolor="lightBlue" align="left">
<th>CourierId</th>

			<th>ReceiverName</th>
			<th>ReceiverAddress</th>
			<th>ReceiverMobileNo</th>
			<th>ReceiverEmailId</th>
			<th>SenderName</th>
			<th>SenderAddress</th>
			<th>SenderMobileNo</th>
			<th>SenderrEmailId</th>
			<th>CourierWeight</th>
			<th>Status</th>
			...
			<%
				...
				while (itr.hasNext()) {
					Courier courier = (Courier) itr.next();
			%>
			<tr>

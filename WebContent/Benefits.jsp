...
<%@page import="com.beans.EstimationCost"%>
...
<div id="header-bg">
	...
	<div id="header">
		<a href="index.html"><img src="images/we-care.png" alt="Package" width="255" height="62" border="0" class="logo" title="Package" /></a>
...
<div id="navigation-bg">
	...
	<div id="navigation">
		...
		<a href="Signup.jsp" class="signup" title="signup now"></a>
		<br class="spacer" />
		<ul class="subNav">
...
<center><font color="Red"><h2>Following are our main advantages</h2></font></center>

    	<center><h4>1)No registration or monthly fees</h4></center>
    	<center><h4>2)You can have a USA address in 5 minutes simply by registering above.</h4></center>
    	
    	<center><h4>3)Shop USA stores directly from our site.</h4></center>
    	<center><h4>4)We only ship with world renowned companies like DHL, FEDEX, UPS, so that your packages will be delivered in a timely manner.</h4></center>
    	<center><h4>5)You will save up to 60% in your shipping costs. Due to our high volume of shipping we can negotiate deep discounts from our carriers which we pass on to you. Please click on the link below to see our rates. </h4></center>
    	<center><h4>6)We consolidate your packages free of charge.</h4></center>
    	<center><h4>7)Shipping 4 or 5 packages is always cheaper per package than shipping only one package.</h4></center>
    	<center><h4>8)Free storage of your package for 30 days.</h4></center>

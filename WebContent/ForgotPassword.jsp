...
<div id="header-bg">
	...
	<div id="header">
		<a href="index.html"><img src="images/we-care.png" alt="Package" width="255" height="82" border="0" class="logo" title="Package" /></a>
		...
		<div id="login-bg">
			...
			<div id="login-area">
				<form action="./login" method="post" name="Login" id="Login">
					...
					<a href="ForgotPassword.jsp " title="forgot password" ><font color="Green">Forgot Password ?</font></a>
...
<tr>
<td> Enter UserName<input type="text" name="uname"></td>
</tr>
<tr>
<td> Enter Email<input type="text" name="email"></td>
</tr>
<tr>
<td><input type="submit" name="get my password" value="Get My Password"></td>
</tr>

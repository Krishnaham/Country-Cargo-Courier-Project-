...
<td>Enter UserName<input type="text"  name="username"></td></tr>
<tr>

<td>Enter Type<input type="text"  name="type"></td></tr>
<tr>
<tr>
<td>
                 ...
                 <th>Mobile Number</th>
						...
						<%
							...
							while (itr.hasNext()) {
								...
								<td><input type="text" name="uname" value="<%=ub.getUserName() %>" /></td>
								<%System.out.println("in jsp while "+ ub.getUserName());
								%>
								<td><input type="text" name="pass" value="<%=ub.getPassWord() %>" /></td>
								<td><input type="text" name="type" value="<%=ub.getType() %>" /></td>
								<td><input type="text" name="emailid" value="<%=ub.getEmail() %>" /></td>
								<td><input type="text" name="mobilenumber" value="<%=ub.getMobileNumber() %>" /></td>
